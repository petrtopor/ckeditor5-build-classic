...
export default class ImageEditing extends Plugin {
	...
	init() {
		...
		schema.register( 'image', {
			...
			isBlock: true,
			allowWhere: '$block',
			allowAttributes: [ 'alt', 'src', 'width', 'height' ]
		} );
      ...
      .add( modelToViewAttributeConverter( 'width' ) )
        ...
        //     let value = viewImage.naturalHeight;
        //     console.log('viewImage.naturalHeight === ', viewImage.naturalHeight)
        //     if (value === undefined) {
        //       console.log('LEIDER viewImage.naturalHeight ist undefined');
        //       value = 100;
        //     }
        //     console.log('Muss wir return value === ', value);
        //     return value;
        //   }
				// }
      } ) )
