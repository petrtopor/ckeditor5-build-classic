...
export default class ImagePropertiesCommand extends Command {
	...
	refresh() {
      ...
      */
      // console.log('Selected IMG naturalWidth === ', document.getElementsByClassName('ck-content')[0].getElementsByTagName('img').filter(img => img.src === element.getAttribute( 'src' )).newValueWidth);
      // console.log('Selected IMG naturalHeight === ', document.getElementsByClassName('ck-content')[0].getElementsByTagName('img').filter(img => img.src === element.getAttribute( 'src' )).newValueHeight);
