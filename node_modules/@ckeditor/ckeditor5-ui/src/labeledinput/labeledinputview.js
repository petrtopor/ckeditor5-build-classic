...
export default class LabeledInputView extends View {
	...
	constructor( locale, InputView ) {
		super( locale );
		// console.log('LabeledInputView::constructor() has been called /w uid() === ', uid());
		const inputUid = `ck-input-${ uid() }`;
    	const statusUid = `ck-status-${ uid() }`;
    	console.log('LabeledInputView::constructor() has been called /w inputUid === ', inputUid, ' and statusUid === ', statusUid);
		// const inputUid = `pizdopidor`;
		// const statusUid = `eblozhopa`;
