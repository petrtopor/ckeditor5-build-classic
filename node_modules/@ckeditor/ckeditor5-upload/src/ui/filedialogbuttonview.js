...
class FileInputView extends View {
    ...
    const ImagePickInputTemplate = {
        ...
        style: 'display: none',
            ...
            console.log('ImagePickInputTemplate::on:change:this.element.files:\n', this.element.files[0]);
        ...
        click: bind.to(() => {
          console.log('ImagePickInputTemplate::on:click:this.element.files:\n', this.element.files);
        })
			}
		}
    // this.setTemplate( ImagePickInputTemplate );
  ...
  fetchImagesFromServer(url) {
    return new Promise((resolve, reject) => {
      ...
      xhr.onload = () => {
        ...
        /* JSDOM MANIPULATION PART ---- BEGIN */
        // const dom = new JSDOM(`<!DOCTYPE html><p>Hello world</p>`);
        // console.log(dom.window.document.querySelector("p").textContent); // "Hello world"
        /* JSDOM MANIPULATION PART ------ END */
